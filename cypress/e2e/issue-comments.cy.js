...
describe('Issue comments creating, editing and deleting', () => {
    ...
    it('Should create,edit and delete comment successfully', () => {
        ...
        const comment_edited = faker.lorem.sentence();
        ...
        getIssueDetailsModal().within(() => {
            ...
            cy.get('[data-testid="issue-comment"]').should('contain', randomComment);
             ...
             //edit comment
            cy.get('[data-testid="issue-comment"]')
                .first().contains('Edit').click().should('not.exist');
            cy.get('textarea[placeholder="Add a comment..."]')
                .clear()
                .type(comment_edited);
            cy.contains('button', 'Save').click().should('not.exist');
        ...
        getIssueDetailsModal()
                .find('[data-testid="issue-comment"]').should('not.contain', comment_edited);
    });
});
